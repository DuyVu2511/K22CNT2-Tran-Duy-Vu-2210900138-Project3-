...
<body>
    <div class="container mt-5">
        <h2 class="text-center">Thêm Chi Tiết Hóa Đơn</h2>
        <form:form modelAttribute="chiTietHoaDon" action="${pageContext.request.contextPath}/chitiethoadon/save" method="post">
            <div class="mb-3">
            ...
            <a href="/chitiethoadon_list" class="btn btn-secondary">Hủy</a>
        </form:form>
    </div>
